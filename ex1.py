...
circle_nodes, circle_labels, circle_boundary_vals, circle_deriv_lambdas = node_utils.make_circle(circle_centre, circle_rad, 50, "D", 2, lambda centre_pos, positions: normal_derivs.radial(centre_pos, positions, shape_param, direction="outwards"))
...
while True:
    ...
    if t % 1000 == 0 or t == 1 or max_resid <= 1e-6:
        ...
        plt.ylabel("y")
        # plt.show()
        plt.savefig(f"report_figs/ex1/{t}.pdf")
